    ...
    return (
        <div>
            <Link href={`/pokemon/${name}`}>
                <div className="flex flex-col p-4 rounded-xl bg-[#F0F0F0] w-72 items-center border-8 hover:bg-gray-50" style={{ borderColor: data ? typeColors[data.types[0].type.name].background : 'slategray' }}>
