    ...
    return (
        <div >
            <Link href={`/pokemon/${name}`}>
                <div className="flex flex-col p-4 rounded-xl bg-white w-80 h-[22rem] items-center border-8 hover:bg-slate-100" style={{ borderColor: data ? typeColors[data.types[0].type.name].background : 'slategray' }}>
