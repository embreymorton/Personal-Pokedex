...
export default function PokemonDetailsPage({pokemon, species} : PokemonDetailsPageProps) {
    ...
    return (
        <div className="p-6 bg-slate-300">
            ...
            <div className="bg-white flex flex-col items-center justify-center w-[30rem] rounded-3xl border-[6px] border-slate-700" style={{borderColor: typeColors[pokemon.types[0].type.name].background}}>
            ...
            <div className="flex flex-col gap-4 max-w-[30rem]">
                <div className="flex bg-white text-slate-700 p-4 rounded-xl border-[6px] border-slate-700">
                <p className="text-3xl text-center">{species.flavor_text_entries[0].flavor_text}</p>
                </div>
                
                <div className="flex flex-row gap-4">
                <div className="flex flex-col w-[550px] gap-2 bg-white text-slate-700 p-4  rounded-xl border-[6px] border-slate-700 items-center">
            ...
            {species.evolves_from_species ? 
                    <div className="bg-white p-4 w-[26rem] h-[30.5rem] border-[6px] rounded-2xl border-slate-700">
            ...
            <h2 className="flex text-6xl font-bold items-center justify-center p-4 mb-4 text-slate-700"> Moves </h2>
